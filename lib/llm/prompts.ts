...
export const SAFETY_RULES = [
  "Only reference numbers present in the input JSON. Do not invent signals, averages, percentages, or counts.",
  ...
  "Flag anomalies when a value is ≥2x or ≤0.5x the department average, and cite the specific multiplier or difference.",
